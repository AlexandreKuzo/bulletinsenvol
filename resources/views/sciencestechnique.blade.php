        ...
        <div class="column is-9">
            <div class="card">
                <header class="card-header">
                    ...
                    <form class="login-form" method="POST" action="{{ url('sciencestechnique') }}">
                        {{ csrf_field() }}
         ...
         <section class="section is-small">
             ...
             <select name="classe_niveau">
              ...
              <div class="field is-horizontal">
                ...
                <div class="field is-horizontal">
                            <div class="field-label">
                                <label class="label">Enseignement technologique</label>
                            </div>

                            <div class="field-body">
                                <div class="field">
                                    <p class="control">
                                        <input class="input" id="technologie" type="number" name="technologie"
                                               value="{{ old('technologie') }}" required >
                                    </p>

                                    @if ($errors->has('technologie'))
                                        <p class="help is-danger">
                                            {{ $errors->first('digits') }}
                                        </p>
                                    @endif
